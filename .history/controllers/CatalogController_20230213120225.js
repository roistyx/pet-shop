...
module.exports = class CatalogController {
	...
	static async searchPet(req, res) {
		...
		console.log(
			'termtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermtermterm',
			term
		);
		return res.status(200).json({
			success: true,
		...
		// try {
		// 	const petList = await CatalogDAO.searchPetByTerm(term);
		// 	console.log('petList', petList);
		// 	return res.status(200).json({
		// 		success: true,
		// 		message: 'pet list',
