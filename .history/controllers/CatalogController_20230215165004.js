...
module.exports = class CatalogController {
	...
	static async petListByUserId(req, res) {
		...
		try {
			const petToUpdate = await CatalogDAO.getPetById(req.params);
			console.log('ids', petToUpdate.currentOwner, userId);

			if (!petToUpdate || petToUpdate.currentOwner !== userId) {
	...
	static async updatePet(req, res) {
		const petObject = {
			...
			currentOwner: [req.currentUser._id, req.body.adoptionStatus],
		};
		// petObject.petCreatedByUsername = req.currentUser.username;
